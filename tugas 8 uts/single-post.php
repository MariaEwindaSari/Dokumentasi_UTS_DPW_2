    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="single-post.php">postingan</a></li>
        ...
        <div class="row">
          <div class="col-md-9 post-content" data-aos="fade-up">
            ...
            <?php if (isset($_POST["kirim"])) 
              ...
              $koneksi->query("INSERT INTO komentar(id_pengguna, id_artikel, tanggal, komentar)
              VALUES( '$id_pengguna' , '$id_artikel', '$tanggal', '$komentar')");						
            }
            ?>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="footer-content">
      <div class="container">
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <h3 class="footer-heading">Tentang Windablogspot</h3>
            <p>website ini digunakan bagi orang yang ingin mendapatkan informasi tentang seputar duna hiburan , bisnis , olahraga , jalan - jalan , politik dan lain-lain</p>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <div class="copyright">
              © Copyright <strong><span>teknik informatika</span></strong>. All Rights Reserved
            </div>
            ...
            <div class="credits">
              ...
              Designed by <a href="https://bootstrapmade.com/">winda</a>
            </div>
