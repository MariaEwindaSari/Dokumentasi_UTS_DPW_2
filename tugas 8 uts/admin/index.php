...
?>
<?php $ambil=$koneksi->query("SELECT*FROM admin JOIN admin_blog ON admin.id_admin=admin_blog.id_admin");
...
float: right;
font-size: 16px;">&nbsp; <a href="index.php?halaman=komentar"><i class="fa fa-envelope fa-lg" ></i></a>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a class="active-menu"  href="index.php?halaman=kategori"><i class="#"></i> Kategori</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=artikel"><i class="#"></i> Artikel</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=komentar"><i class="#"></i> Komentar</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=pengguna"><i class="fa fa-user"></i> pengguna</a></li>
